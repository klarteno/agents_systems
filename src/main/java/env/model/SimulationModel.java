...
public class SimulationModel extends ActionModel {
	...
	public SimulationModel(GridOperations model, int step, Agent agent, Cell tracked)
	{
		this(model, step, agent, tracked, tracked instanceof Agent);
	}

	public SimulationModel(GridOperations model, int step, Agent agent, Cell tracked, boolean isAgent)
	{
		super(model);
